...
<article class="container">
    ...
    <div class="col-sm-6 col-md-offset-3">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sample2_postcode" name="mem_zipcode" value='<c:out value="${memberVO.mem_zipcode }"/>' readonly placeholder="우편번호를 입력해주세요">
                
            </div>
            <div class="form-group">
                <label for="sample2_address">기본주소</label>
                <input type="text" class="form-control" id="sample2_address" name="mem_addr" value='<c:out value="${memberVO.mem_addr }"/>' readonly placeholder="기본주소를 입력해주세요">
            </div>
            <div class="form-group">
                <label for="sample2_detailAddress">나머지주소</label>
                <input type="text" class="form-control" id="sample2_detailAddress" name="mem_addr_d" value='<c:out value="${memberVO.mem_addr_d }"/>' readonly placeholder="나머지주소를 입력해주세요">
