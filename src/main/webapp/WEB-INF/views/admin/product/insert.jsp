            ...
            <form role="form" id="productForm" action="/admin/product/insert" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
              	<div class="col-md-6">
	                  ...
	                  <input type="text" id="pdt_name" name="pdt_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product-name">
	                </div>
	            </div>
	            <div class="col-md-6">
	                <div class="form-group">
	                  <label for="pdt_company">제조사</label>
	                  <input type="text" id="pdt_company" name="pdt_company" class="form-control" id="exampleInputEmail1" placeholder="Enter company">
	                </div>
	          	</div>
              </div>
                <div class="form-group">
				...
				<div class="row">
					<div class="col-md-3">
		                <div class="form-group">
		                  ...
		                  <input type="text" id="pdt_price" name="pdt_price" class="form-control" id="exampleInputEmail1" placeholder="Enter price">
		                </div>
		            </div>
		            <div class="col-md-3">
		                <div class="form-group">
		                  <label for="pdt_discount">할인</label>
		                  <input type="text" id="pdt_discount" name="pdt_discount" class="form-control" id="exampleInputEmail1" placeholder="Enter discount">
		                </div>
		            </div>
		            <div class="col-md-3">
		                <div class="form-group">
		                  <label for="pdt_amount">수량</label>
		                  <input type="text" id="pdt_amount" name="pdt_amount" class="form-control" id="exampleInputEmail1" placeholder="Enter amount">
		                </div>
		            </div>
		            <div class="col-md-3">
		            	<div class="form-group">
